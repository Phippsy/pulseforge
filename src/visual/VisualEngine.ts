...
export class VisualEngine {
  ...
  setEffect(name: EffectName): void {
    ...
    const useOrtho = name === 'tunnel' || name === 'fractal' || name === 'metaballs' || name === 'plasma' || name === 'voronoi' || name === 'aurora' || name === 'geoKaleidoscope' || name === 'rings' || name === 'equaliser' || name === 'soundwaves' || name === 'fire' || name === 'superscope' || name === 'milkdrop' || name === 'waterRipple' || name === 'matrixRain' || name === 'rorschach' || name === 'spiralVortex' || name === 'nebula' || name === 'electricArc' || name === 'spaceInvaders' || name === 'ceefax' || name === 'fireworks' || name === 'discoBall' || name === 'pacman' || name === 'lavaLamp' || name === 'acidSmiley' || name === 'neonSigns' || name === 'lightning' || name === 'donkeyKong' || name === 'tetris';
